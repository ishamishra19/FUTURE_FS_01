        ...
        <div className="grid-bento mt-8">
          ...
          >
            ...
            <p className="mt-5 max-w-xl text-base sm:text-lg text-foreground/80 leading-relaxed">
              {PROFILE.tagline} I’m a final-year Computer Science student at C.V.
              Raman Global University, passionate about transforming ideas into
            ...
            <div className="mt-4 overflow-hidden">
              <div className="marquee">
                {[...MARQUEE, ...MARQUEE].map((tech, i) => (
                  <span
                    key={i}
                    className="font-mono text-sm text-foreground/80 whitespace-nowrap"
                  >
