    ...
    <SiteShell>
      <section className="mx-auto max-w-5xl px-5 sm:px-8 pt-12 pb-16">
        ...
        <p className="mt-6 max-w-2xl text-foreground/80 leading-relaxed text-lg">
          I'm {PROFILE.name}, a final-year Computer Science student at C.V. Raman Global University
          in Bhubaneswar. I've spent the last two years falling in love with the web — building
          interfaces, joining hackathons, and learning how to make even small interactions feel
          considered.
        </p>
        ...
        <div className="grid-bento mt-10">
          ...
          <div className="bento-tile p-7" style={{ gridColumn: "span 2" }}>
            <div className="flex items-center gap-2 text-mint">
              ...
              <p className="font-mono text-xs uppercase tracking-wider">Certifications</p>
            </div>
          ...
          {/* Coursework */}
          <div className="bento-tile p-7" style={{ gridColumn: "span 2" }}>
            <p className="font-mono text-xs uppercase tracking-wider text-mint">Coursework</p>
          ...
          <div className="bento-tile p-7" style={{ gridColumn: "span 4" }}>
            ...
            <p className="font-serif text-2xl italic mt-4 max-w-2xl leading-snug">
              When I'm not in the editor, you'll find me{" "}
              {INTERESTS.slice(0, -1).join(", ").toLowerCase()} or{" "}
              {INTERESTS[INTERESTS.length - 1].toLowerCase()}.
            </p>
          </div>
        </div>
      </section>
