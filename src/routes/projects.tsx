    ...
    <SiteShell>
      <section className="mx-auto max-w-6xl px-5 sm:px-8 pt-12 pb-16">
        ...
        <p className="mt-5 max-w-2xl text-foreground/80 leading-relaxed">
          Selected work from hackathons and personal explorations. Each one taught me something I
          now use every day.
        </p>
              ...
              <Link to="/projects/$slug" params={{ slug: p.slug }} className="block">
                <div className="flex items-start justify-between gap-4">
                  <div>
                    ...
                    <p className="mt-3 text-foreground/80 max-w-2xl leading-relaxed">{p.tagline}</p>
                  </div>
