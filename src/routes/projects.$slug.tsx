  ...
  notFoundComponent: () => (
    <SiteShell>
      <div className="mx-auto max-w-2xl px-5 sm:px-8 py-24 text-center">
        ...
        <Link to="/projects" className="mt-6 inline-flex items-center gap-2 text-mint link-sweep">
  ...
  return (
    <SiteShell>
      <article className="mx-auto max-w-4xl px-5 sm:px-8 pt-12 pb-16">
        ...
        <h1 className="mt-3 font-serif text-5xl sm:text-6xl leading-[1.05]">{project.title}</h1>
        ...
        <div className="grid-bento mt-10">
          ...
          <div className="bento-tile p-7" style={{ gridColumn: "span 4" }}>
            <p className="font-mono text-xs uppercase tracking-wider text-mint">The problem</p>
            <p className="mt-3 text-foreground/85 leading-relaxed">{project.problem}</p>
          </div>

          <div className="bento-tile p-7" style={{ gridColumn: "span 2" }}>
            <p className="font-mono text-xs uppercase tracking-wider text-mint">Highlights</p>
          ...
          <div className="bento-tile p-7" style={{ gridColumn: "span 2" }}>
            <p className="font-mono text-xs uppercase tracking-wider text-mint">Outcomes</p>
            <ul className="mt-4 space-y-3">
