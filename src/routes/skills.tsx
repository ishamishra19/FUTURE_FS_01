  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Skills — Isha Mishra" },
      {
        ...
        content: "Languages, frontend frameworks, databases and tools Isha works with day to day.",
      },
    ],
  }),
    ...
    <SiteShell>
      <section className="mx-auto max-w-5xl px-5 sm:px-8 pt-12 pb-16">
        ...
        <p className="mt-5 max-w-2xl text-foreground/80 leading-relaxed">
          A snapshot of what's in my toolbox today. I'm always picking up new things — currently
          digging into animation libraries and design systems.
        </p>
        ...
        <div className="grid-bento mt-10">
          {SKILLS.map((g, i) => (
            ...
            >
              <p className="font-mono text-xs uppercase tracking-wider text-mint">{g.group}</p>
